...
//            Lunch/Dinner
            ...
            MainListActivity.eventsDB.execSQL("INSERT INTO " +
                    "events " +
                    "VALUES ('każdy zasługuje na drugą szansę', 'Ngo restaurant', 'Restaurant', 'Jugoslávská 661/23, 120 00 Vinohrady, Czechy', 'Wiem, wiem. Wietnamska i tylko 800 opinii. Jednakże, każdy zasługuje na druga szansę, nawet kolendra w kuchni wietnamskiej! Mają wyśmienite opinie, a ich karta dań jest krótka i wygląda mega interesująco. No i ceny - nader przystępne. Na lunch, żeby sobie podjeść, spróbować (znów) czegoś nowego. Poza tym, ta kuchnia używa dużo afrodyzjaków...', '0', 'Sobota 9:15', 'pct_ngo', '380000')");
...
//            Pubs/Additional food
            ...
            MainListActivity.eventsDB.execSQL("INSERT INTO " +
                    "events " +
                    "VALUES ('tradycyjne kominowe zawijasy', 'Trdelniki, takie jak w Krakowie', 'Patisserie', 'Josefov CZ, U Starého Hřbitova 42/2, Staré Město, 110 00 Praha, Czechy', 'Trdelník & Coffee - nazwa trochę bez polotu, ale... TRDELNIKI! Pomimo, że są to Czechy, a trdelniki są na każdym rogu, najczęściej nie mają wysokich ocen. I oto nadchodzi on! Zbawca słodkich kominów, najwyżej oceniane w Pradze - Trdelnik & Coffe! Tradycyjne, a jednak z lodami! Nasz must aby spróbować prawdziwych, oryginalnych kominowych zawijasów!', '0', 'Czwartek 10:00', 'pct_trdelnik_coffe', '600000')");
            MainListActivity.eventsDB.execSQL("INSERT INTO " +
                    "events " +
                    "VALUES ('modernistyczne kominowe zawijasy', 'Trydelniki naszych czasów', 'Patisserie', 'Karlova 160/8, 110 00 Staré Město, Czechy', 'Good Food Coffee & Bakery serwuje trydelniki w formie turystycznej. Milion posypek, lodów i niestety trochę wyższe ceny. Są nawet trydelniki wytrawne z serem i pomidorem! Co prawda miejsce stworzone pod turystów, ale biorąc pod uwagę że większość Trydenlików ma niskie opinie, może warto spróbować Trydelnika w całości OBSYPANEGO PISTACJAMI?', '0', 'Czwartek 10:00', 'pct_good_food', '630000')");
            MainListActivity.eventsDB.execSQL("INSERT INTO " +
                    "events " +
            ...
            MainListActivity.eventsDB.execSQL("INSERT INTO " +
                    "events " +
                    "VALUES ('ciostko w ogrodzie', 'Cafe V zahradě', 'Patisserie', 'nám. Bratří Synků 400/12, 140 00 Praha 4-Nusle, Czechy', 'Urokliwa kawiarnio-śniadaniownia zmalowniczym ogródkiem. Niech nie zwiedzie Cię niewielka ilość opinii (tylko 400), ocena 4,9 to coś w co zawsze celujemy. Poza tym na fotkach widać, że ewidentnie \"robią to dobrze\". Czy chceesz słodkie, czy słone - na pewno znajdziesz tu coś dla siebie. Oraz chwilę wytchnienia.', '0', 'Czwartek 10:00', 'pct_cafe_zahrade', '656550')");
            MainListActivity.eventsDB.execSQL("INSERT INTO " +
                    "events " +
                    "VALUES ('czajniczkowanie', 'Čajovna jedna báseň', 'Patisserie', 'Pod Zvonařkou 14, 120 00 Praha 2-Vinohrady, Czechy', 'Nie lubisz kawy, ja też nie. Ta nienawiść zawsze łączyła nas bardziej niż cokolwiek innego! Dlatego chodź ze mną, po raz pierwszy w życiu, do herbaciarni Jedna Baśń! Baśniowy, jedyny w swoim rodzaju wystrój, połączony z niespotykanymi naparami zrelaksują nas i pozwolą odpocząć po nieustającej gonitwie. Poza tym, w środku mieszka KOTEŁ! ', '0', 'Czwartek 10:00', 'pct_jedna_basen', '656555')");
