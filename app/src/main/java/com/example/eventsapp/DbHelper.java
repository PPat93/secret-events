...
//            Lunch/Dinner
            ...
            MainListActivity.eventsDB.execSQL("INSERT INTO " +
                    "events " +
                    "VALUES ('jak się nie ma co się lubi', 'Lokál U Bílé kuželky', 'Restaurant', 'Míšeňská 12, 110 00 Malá Strana, Czechy', 'Czeskie, tradycyjne jedzenie - niestety nie u Glaubiców - prawdopodbnie coś nie pykło. W zamian idziemy do bardzo zbliżonej restauracji. Jedyne co, to mają połowę mniej opinii, tylko 6k. Piwo ważą sami na miejscu i chwalą się że dają tyle sosu i side dish ile dasz radę zjeść. To teraz przestań się krzywić i pij ten sos. Zapłacone, więc nie grymaś!', '0', 'Sobota 9:15', 'pct_bile_kuzelky', '356500')");
            MainListActivity.eventsDB.execSQL("INSERT INTO " +
                    "events " +
...
//            Pubs/Additional food
            ...
            MainListActivity.eventsDB.execSQL("INSERT INTO " +
                    "events " +
                    "VALUES ('czajniczkowanie', 'Čajovna jedna báseň', 'Teahouse', 'Pod Zvonařkou 14, 120 00 Praha 2-Vinohrady, Czechy', 'Nie lubisz kawy, ja oczywiście też nie. Ta nienawiść zawsze łączyła nas bardziej niż cokolwiek innego! Dlatego chodź ze mną, po raz pierwszy w życiu, do prawdziwej herbaciarni! Jedna Baśń oferuje (jak nazwa wskazuje) baśniowy, jedyny w swoim rodzaju wystrój. Niespotykane napary zrelaksują nas i pozwolą odpocząć po nieustającej gonitwie. Poza tym, w środku mieszka KOTEŁ!', '0', 'Czwartek 10:00', 'pct_jedna_basen', '656555')");
...
//            Attractions
            ...
            MainListActivity.eventsDB.execSQL("INSERT INTO " +
                    "events " +
                    "VALUES ('dom publiczny', 'Obecní dům', 'Attraction', 'Náměstí Republiky 5, 111 21 Staré Město, Czechy', 'Przyznam szczerze, że tłumaczenie nazwy tego miejsca jest co najmniej konfundujące. Najbliższe i najsensowniejsze co znalazłem to ''Dom reprezentacyjny'' albo po angielsku ''Municipal House''. Tak czy siak - duże, ładne, stare, antyczne, z historią. Jednen z najstarszych budynków secesyjnych. Pełni obecnie funkcje reprezentacyjne. Ma sale koncertowe i zakładam że zwiedzanie zapadnie Ci w pamięć.', '0', '12:00', 'pct_obecni_dum', '1098906')");
            MainListActivity.eventsDB.execSQL("INSERT INTO " +
                    "events " +
